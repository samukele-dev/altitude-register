            ...
            <div className="chart-body">
              {campaignsList.length > 0 ? (
                ...
                <p style={{ textAlign: 'center', color: '#999', padding: '20px' }}>
                  No campaigns yet. Create one when enrolling employees.
                </p>
              )}
            </div>
          </div>
          ...
          <div className="chart-card">
            ...
            <div className="chart-body">
              {teamsList.length > 0 ? (
                ...
                <p style={{ textAlign: 'center', color: '#999', padding: '20px' }}>
                  No teams yet. Create one when enrolling employees.
                </p>
              )}
            </div>
          </div>
                ...
                {recentAttendance.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="5" className="empty-state">
                      No recent clock-ins. Employees need to clock in first.
                    </td>
                  </tr>
                )}
              </tbody>
